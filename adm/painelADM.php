            ...
            <div id="content">
                <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <!-- Menssagems -->
                        <li class="nav-item dropdown no-arrow mx-1">
                            <a class="nav-link dropdown-toggle" href="www.google.com">
                        ...
                        <li class="nav-item dropdown no-arrow">
                            <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button"
                                data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                <label class="px-3 mr-2 d-none d-lg-inline m-0 text-gray-600 small">Douglas
                                    McGee</label>
                            </a>
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        ...
                        <a href="#" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm"><i
                                class="fas fa-download fa-sm text-white-50"></i> Baixar Relatorio</a>
                    </div>
                    <!-- Content Row -->
                    <div class="row">
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    Tem certeza que esta pronto para encerrar sua sessão atual?</div>
                <div class="modal-footer">
                    <button class="btn btn-secondary btn2" type="button" data-dismiss="modal">Cancelar</button>
                    <a class="btn2 btn btn-primary" href="login.html">Sair</a>
                </div>
            </div>
        </div>
    </div>
